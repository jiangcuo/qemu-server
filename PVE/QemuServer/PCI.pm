...
sub get_pci_addr_map {
	...
	'ivshmem' => { bus => 0, addr => 11 },
	'audio0' => { bus => 0, addr => 12 },
	'rng0' => { bus => 0, addr => 13 },
	vga1 => { bus => 0, addr => 24 },
	vga2 => { bus => 0, addr => 25 },
	'pci.4' => { bus => 0, addr => 29 },
	'pci.1' => { bus => 0, addr => 30 },
	'pci.2' => { bus => 0, addr => 31 },
	scsihw0 => { bus => 1, addr => 1, conflict_ok => qw(pci.3) },
	'pci.3' => { bus => 1, addr => 1, conflict_ok => qw(scsihw0) }, # also used for virtio-scsi-single bridge
	'net0' => { bus => 1, addr => 2 },
	'net1' => { bus => 1, addr => 3 },
	'net2' => { bus => 1, addr => 4 },
	'net3' => { bus => 1, addr => 5 },
	'net4' => { bus => 1, addr => 6 },
	hostpci0 => { bus => 1, addr => 7 },
	hostpci1 => { bus => 1, addr => 8 },
	hostpci2 => { bus => 1, addr => 9 },
	hostpci3 => { bus => 1, addr => 10 },
	hostpci4 => { bus => 1, addr => 11 },
	hostpci5 => { bus => 1, addr => 12 },
	hostpci6 => { bus => 1, addr => 13 },
	hostpci7 => { bus => 1, addr => 14 },
	hostpci8 => { bus => 1, addr => 15 },
	hostpci19 => { bus => 1, addr => 16 },
	hostpci10 => { bus => 1, addr => 17 },
	'xhci' => { bus => 1, addr => 18 },
	'virtio0' => { bus => 1, addr => 19 },
	'virtio1' => { bus => 1, addr => 20 },
	'virtio2' => { bus => 1, addr => 21 },
	'virtio3' => { bus => 1, addr => 22 },
	'virtio4' => { bus => 1, addr => 23 },
	'virtioscsi0' => { bus => 1, addr => 24 },
	'virtioscsi1' => { bus => 1, addr => 25 },
	'virtioscsi2' => { bus => 1, addr => 26 },
	'virtioscsi3' => { bus => 1, addr => 27 },
